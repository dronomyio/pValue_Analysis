...
st.set_page_config(
    page_title="P-Value Analysis (Lightweight)",
    page_icon="📊",
    layout="wide",
...
st.markdown("""
This lightweight application demonstrates two key concepts from Nassim Nicholas Taleb's paper on p-values:
...
tab1, tab2 = st.tabs(["Meta-Distribution of P-Values", "P-Value Hacking"])
...
This lightweight application focuses on just two key concepts from Taleb's paper for better performance.
""")

# Add a small note about loading time
st.sidebar.markdown("### About This App")
st.sidebar.info("""
This is a lightweight version of the p-value analysis application, focusing only on the two most important concepts from Taleb's paper for faster loading and better performance.
